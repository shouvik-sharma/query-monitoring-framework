...
- Format: JPG or PNG, 1000x1000px (square)
- Background: Professional or tech-focused
- Use: LinkedIn, Medium, conference materials
...
1. **LLM-Powered Query Monitoring: Reproducible Evaluation Framework**
   - How to build reproducible benchmarks for LLM-based SQL analysis
   - Honest metrics: detection accuracy, semantic validation, and cost tracking
   - Open-source framework for the community

2. **Building Production-Grade AI/ML Features**
   - Leveraging LLMs without managing ML pipelines
   - Handling API costs & rate limits
   - Testing & validation for LLM-generated code

3. **Data Engineering in the Age of AI**
   - Automation patterns for data ops
   - Common pitfalls when using AI in data systems
   - Future of LLMs in data infrastructure

## Publications

### Primary
- **"LLM-Powered Query Monitoring and Optimization Using Reproducible External Data Workloads"** (2026)
  - Available: GitHub (open source) | RESEARCH_PAPER.md
...
**Technical Skills:**
- Cloud Data Warehouses: Snowflake, DuckDB, PostgreSQL
- SQL & Query Optimization: 5+ years production experience
- Python, Data Engineering: 5+ years
- LLMs & AI: GPT-4/4o-mini, Prompt Engineering, Semantic Validation

**Experience:**
- Data Engineer at Chime (current)

**Open Source:**
- Author: query-monitoring-framework (https://github.com/shouvik-sharma/query-monitoring-framework)
